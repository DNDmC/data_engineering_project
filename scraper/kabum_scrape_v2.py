...
# =========================================================
# Argparse (compatível com seus flags antigos + novos)
# =========================================================
...
def _derive_input_from_legacy(args) -> Tuple[str, str]:
    ...
    # IMPORTANTE: seu projeto está usando inbox/kabum/...
    # Se você já passa gold-prefix como "kabum/enrichment", a gente tenta mapear para "inbox/kabum/gold_enrichment_v1"
    # MAS como você pode variar, vamos ser conservadores:
    # - se prefix já começa com "inbox/", usa como está
    # - senão, prefix vira "inbox/" + prefix
